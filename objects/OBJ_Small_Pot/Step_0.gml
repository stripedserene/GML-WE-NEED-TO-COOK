...
if place_meeting(x, y, OBJ_Player) and OBJ_Player.carrying != OBJ_Player.None and cooking == false and array_length(Holding) < 2 and array_contains(Holding, OBJ_Player.carrying) == false and burning == false{
	...
	OBJ_Controls_Text.Appliance = "Small Pot"
	if keyboard_check_pressed(ord("R")){
		array_push(Holding, OBJ_Player.carrying)
		OBJ_Player.carrying = OBJ_Player.None
	}
}
if place_meeting(x, y, OBJ_Player) and OBJ_Player.carrying != OBJ_Player.None and cooking == false and array_length(Holding) < 2 and array_contains(Holding, OBJ_Player.carrying) == true{
	instance_create_layer(x, y - 20, "TEXT_DISPLAY_LAYER", OBJ_Controls_Text)
...
if place_meeting(x, y, OBJ_Player) and OBJ_Player.carrying != OBJ_Player.None and cooking == false and array_length(Holding) > 1{
	instance_create_layer(x, y - 20, "TEXT_DISPLAY_LAYER", OBJ_Controls_Text)
...
if place_meeting(x, y, OBJ_Player) and array_length(Holding) != 0 and cooking == false and burning == false and array_length(Holding) > 1 {
	...
	OBJ_Controls_Text_2.Appliance = "Small Pot"
